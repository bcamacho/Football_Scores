...
public class Utilies
{
    ...
    public static String getLeague(int league_num)
    {
        switch (league_num)
        {
            ...
            case PREMIER_LEGAUE : String.valueOf(R.string.premierleague);
            ...
            default: return String.valueOf(R.string.unknown_league_default);
        }
    }
    public static String getMatchDay(int match_day,int league_num)
    {
        if(league_num == CHAMPIONS_LEAGUE)
        {
            if (match_day <= 6)
            {
                String lessThanSeven = String.valueOf(R.string.group_stage_text) + ", " +
